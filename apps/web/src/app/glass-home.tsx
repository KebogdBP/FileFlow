...
> = {
  ...
  'extract-subtitles': {
    ...
    description: 'Edit, export and explore subtitle text with AI',
    icon: Subtitles,
    tone: 'mint',
  },
  'optimize-audio': {
...
const toolTranslations: Record<Exclude<Language, 'en'>, Record<string, [string, string]>> = {
  ru: {
    ...
    'Extract subtitles': ['Извлечь субтитры', 'Редактировать, экспортировать и изучать текст с ИИ'],
  ...
  es: {
    ...
    'Extract subtitles': ['Extraer subtítulos', 'Editar, exportar y analizar el texto con IA'],
...
const localizedCopy = {
  ...
  ru: {
    ...
    viewAll:
      '\u0412\u0441\u0435 \u0438\u043d\u0441\u0442\u0440\u0443\u043c\u0435\u043d\u0442\u044b',
    toolCount: '19 рабочих инструментов',
    moreTools: 'ещё',
  ...
  es: {
    ...
    viewAll: 'Ver herramientas',
    toolCount: '19 herramientas activas',
    moreTools: 'más',
